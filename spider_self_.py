...
def parse(html,url):
    ...
    for i in range(0,18,1):
        ...
        sql='insert into jd_discount_self(id,reduction,get_url,used_url,payment,requirement,platform,coupon_type,starttime,endtime,url,discount) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
